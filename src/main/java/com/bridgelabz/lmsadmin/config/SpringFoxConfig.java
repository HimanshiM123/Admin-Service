package com.bridgelabz.lmsadmin.config;
   ...
   public Docket api() {
    ...
    public Docket api() {
        ...
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .apis(RequestHandlerSelectors.basePackage("com.bridgelabz.lmsadmin.controller"))
   ...
   /*private ApiInfo getApiInfo() {
    ...
    private ApiInfo apiInfo() {
        ...
        return new ApiInfo("LMSAdmin",
                ...
                new Contact("LMSProject", "http://bridgelabz.lmsadmin", "himanshi1252@gmail.com"),
